...
```bash
PYTHONPATH=. python scripts/run_bernoulli_mnist.py fit --config ./configs/bernoulli_mnist.yaml --ckpt_path ./egs/bernoulli_mnist/binary_mnist/version_4/checkpoints/best-checkpoint.ckpt
