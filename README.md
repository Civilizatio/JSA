...
``` bash
tensorboard --logdir=egs/cifar10/jsa/categorical_prior_conv/2026-03-27_15-03-48 --port=6024
```

``` bash

tensorboard --logdir=egs/cifar10/perceptual_jsa/cifar10_stage1_decoder/2026-03-29_12-47-24 --port 6023
```
